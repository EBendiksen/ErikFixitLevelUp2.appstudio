...
const cacheName = 'ErikFixItLevelup2-2020-09-20 21:51:09.147967'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'ErikFixItLevelup2'.length) === 'ErikFixItLevelup2') {
